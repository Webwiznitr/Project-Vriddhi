...
const Contact = () => {
  return (
    <>
      <div className="text-white bg-[#111a21] h-[100vh]  ">
        <Navbar />
        ...
        <div className="mt-20">
          ...
          <div className="mx-auto max-w-screen-md px-4 space-y-5">
            <div className="flex space-x-1">
              <LocationOnIcon />
              <p>
                National Insitute of Technology Rourkela, Jindal Colony, Udit
                Nagar, Rourkela, Odisha 769001
              </p>
            </div>
            <div className="flex space-x-1">
              <EmailIcon />
              <div>
                <a href="mailto:nitr.vriddhi@gmail.com">
                  nitr.vriddhi@gmail.com
                </a>
              </div>
            </div>
            <div className="flex space-x-1">
